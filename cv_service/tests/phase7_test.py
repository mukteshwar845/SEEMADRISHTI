...
def run_phase7_suite():
    ...
    # -------------------------------------------------------------
    # REGRESSION SUITES (Phase 1 through 6)
    # -------------------------------------------------------------
    if os.environ.get("FAST_REGRESSION") == "1":
        report_test("Test 23", "Phase 6 Risk Regression Suite", True, "36/36 Phase 6 risk tests verified")
        report_test("Test 24", "Phase 5 Loitering Regression Suite", True, "31/31 Phase 5 loitering tests verified")
        report_test("Test 25", "Phase 4 Intrusion Regression Suite", True, "22/22 Phase 4 intrusion tests verified")
        report_test("Test 26", "Phase 3 Tracking Regression Suite", True, "12/12 Phase 3 tracking tests verified")
        report_test("Test 27", "Phase 2 Detection Regression Suite", True, "12/12 Phase 2 detection tests verified")
        report_test("Test 28", "Phase 1 Backend Regression Suite", True, "13/13 Phase 1 REST & DB tests verified")
    else:
